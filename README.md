...
<img width="940" height="274" alt="image" src="https://github.com/user-attachments/assets/57345c07-a38f-4a39-bb9b-379eb9dae1ee" />
...
•	CSS
Used to style the application and make it responsive so it looks good on both mobile and desktop screens.
•	JavaScript
Used to handle the main functionality of the app, including calling the movie API using Fetch, working with asynchronous logic (async/await), dynamically updating the page, and showing loading messages or user feedback.
•	Git & GitHub
...
•	Extract the downloaded ZIP file on computer.
...
Another challenge for me was writing the installation instructions for the project. At first, I was unsure how to explain the installation process, as the application can be used directly through the live URL. While working on this, I learned about cloning a repository and how to run the application locally, which helped me better understand different ways users and developers can access the project.
Even though many of the topics felt difficult at first, I managed to understand the technologies used in this project. I am looking forward to the next course, Web Designing 2, but before that, I plan to review these topics so I do not forget them. I feel very happy and proud that I was able to complete this project using the materials provided in class.
...
|---------|-----------------|----------|
| Core Functionality | 10/10 | Application works as per instructions |
| Code Quality | 4/5 | Code is well‑structured with clear comments |
| UX & Accessibility | 4/5 | Responsive layout and clear user interface |
| Data Handling | 3/4 | API data handled correctly |
| Documentation | 3/3 | README file is clear and complete |
| Deployment | 3/3 | GitHub and live URLs working properly given abouve |
